...
const features = [
  {
    ...
    href: "/features/decentralized-identity",
    description: "Control your identity with blockchain technology.",
  },
  {
    title: "Tokenized Access Control",
    href: "/features/tokenized-access",
    description: "Secure and scalable access management.",
  },
  {
    title: "Compliance Solutions",
    href: "/features/compliance",
    description: "Ensure compliance with GDPR and HIPAA.",
  },
  {
    title: "Identity Recovery Services",
    href: "/features/identity-recovery",
    description: "Multi-signature recovery options for your identity.",
  },
];
      ...
      <div className="flex justify-between w-full min-[825px]:hidden">
        <Dialog>
          ...
          <SheetContent side="left">
            <SheetHeader>
              <SheetTitle>ChainAuth</SheetTitle>
            </SheetHeader>
