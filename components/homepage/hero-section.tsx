      ...
      <div>
        <div className="relative flex max-w-6xl justify-center overflow-hidden mt-7">
          <div className="relative rounded-xl">
            <Image
              src="https://utfs.io/f/31dba2ff-6c3b-4927-99cd-b928eaa54d5f-5w20ij.png" // Update with your image URL
              alt="ChainAuth Dashboard Preview"
              width={1100}
              height={550}
              priority={true}
            ...
            />
            <Image
              src="https://utfs.io/f/69a12ab1-4d57-4913-90f9-38c6aca6c373-1txg2.png" // Update with your dark mode image URL
              width={1100}
              height={550}
              alt="ChainAuth Dark Mode Dashboard Preview"
              priority={true}
