...
const ProjectsData = [
  {
    id: 1,
    name: "ChainAuth Framework",
    description:
      "Decentralized authentication that empowers users with full control over their identities.",
  ...
  },
  {
    ...
    name: "Solana",
    description:
      "High-performance blockchain designed for decentralized applications and crypto projects.",
  ...
  },
  {
    ...
    name: "Alchemy",
    description:
      "Developer platform providing tools and infrastructure for blockchain applications.",
  ...
  },
  {
    ...
    name: "Akash",
    description:
      "Decentralized cloud platform for hosting applications with a focus on scalability.",
  ...
  },
  {
    ...
    name: "Vottun",
    description:
      "Blockchain-based compliance management ensuring data protection regulations are met.",
  ...
  },
  {
    ...
    name: "Rair",
    description:
      "Tokenized Authentication Keys for decentralized access control solutions.",
  ...
  },
  {
    ...
    name: "Prisma ORM",
    description:
      "Modern toolkit for managing databases seamlessly within your applications.",
  ...
  },
  {
    ...
    description:
      "Robust solution for processing payments securely, including subscriptions and one-time transactions.",
  ...
  },
  {
    ...
    name: "Tanstack Query",
    description:
      "Client-side library for data fetching, caching, and synchronization.",
  ...
  },
  {
    ...
    name: "Upstash (Redis)",
    description:
      "Serverless Redis for caching and data management, ideal for modern applications.",
  ...
  return (
    <div className="flex flex-col justify-center items-center lg:w-[75%]">
      <div className="flex flex-col mb-[3rem]">
        ...
        >
          ChainAuth: Built with the Best Technologies
        </h2>
        <p className="mx-auto max-w-[500px] text-gray-600 dark:text-gray-400 text-center mt-2 ">
          Empowering decentralized authentication solutions with
